  ...
  <div>
    <div class="joke">
      <div class="joke__body">
        <img class="joke__user" v-bind:src="user" />
        <p class="joke__text">{{text}}</p>
      </div>

      <div class="joke__likes">
        <button id="btn-up" class="btn-like btn-like--up" v-on:click="plusUp"></button>
        <span id="likes-up" class="likes-count likes-count--up">{{likes}}</span>

        <button id="btn-down" class="btn-like btn-like--down" v-on:click="plusDown"></button>
...
export default {
  name: "Joke",
  props: ["user", "text", "likes", "dislikes"],
